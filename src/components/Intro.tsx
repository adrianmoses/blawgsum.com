  ...
  return (
    <>
      ...
      <h1 className="mt-14 font-display text-4xl/tight font-light text-white">
        ...
        <span className="text-sky-300">for blogging developers</span>
      </h1>
      <p className="mt-4 text-sm/6 text-gray-300">
          Blawgsum is a lightweight headless CMS for blogging developers
          who want to take advantage of automation and AI features.
      </p>
      <SignUpForm />
